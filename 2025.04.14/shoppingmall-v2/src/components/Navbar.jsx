...
import { useSelector } from "react-redux"; // 값을 찾아오는거
import { useDispatch } from "react-redux"; // state 값을 바꾸는 것
import { authenticateAction } from "../redux/actions/authenticateAction"; // 실제로 리듀서에게 값을 보내는 역할
    ...
    <Container>
      ...
      <HeaderTop>
        {trueOk ? (
          <LoginAuth
            onClick={() => {
              dispatch(authenticateAction.getLogout());
              navigate("/");
            }}
          >
